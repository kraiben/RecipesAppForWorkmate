...
fun SearchScreen(
    ...
    onNextPage: (String, DishType, Int) -> Unit,
    onPreviousPage: (String, DishType, Int) -> Unit,
) {
    ...
    val isPageLast by remember(recipesList) { mutableStateOf(isLastPage(currentChunk)) }
    LaunchedEffect(currentChunk) {
            ...
            SearchBar(
                ...
                inputField = {
                    SearchBarDefaults.InputField(
                        ...
                        onSearch = {
                            currentChunk = 0
                            onSearch(searchQuery, selectedDishType, currentChunk)
                        },
                        expanded = false,
                        onExpandedChange = {},
                        trailingIcon = {
